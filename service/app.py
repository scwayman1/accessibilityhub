...
WORKFLOW_STEPS = (("add", "1", "Choose sample"), ("review", "2", "Review findings"), ("improve", "3", "Improve"), ("check", "4", "Check again"))
LANE_PRESENTATION = {
